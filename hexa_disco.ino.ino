...
void loop() {
  delay(1000);
  // Move all Legs forward respectively
  moveMotorCommand(leg1_body, 1600, 1000, 0);
  moveMotorCommand(leg2_body, 1600, 1000, 0);
  moveMotorCommand(leg3_body, 1600, 1000, 0);
  moveMotorCommand(leg4_body, 1600, 1000, 0);
  moveMotorCommand(leg5_body, 1600, 1000, 0);
  moveMotorCommand(leg6_body, 1600, 1000, 0);
  commitMoveMotorCommands();
  delay(1000);

  //move Group A Legs up
  moveMotorCommand(leg1_middle, 1400, 1000, 0);
  moveMotorCommand(leg3_middle, 1400, 1000, 0);
  moveMotorCommand(leg5_middle, 1400, 1000, 0);
  commitMoveMotorCommands();
  delay(1000);
  ...
  // Move all Legs backward respectively
  moveMotorCommand(leg1_body, 1400, 1000, 0);
  moveMotorCommand(leg2_body, 1400, 1000, 0);
  moveMotorCommand(leg3_body, 1400, 1000, 0);
  moveMotorCommand(leg4_body, 1400, 1000, 0);
  moveMotorCommand(leg5_body, 1400, 1000, 0);
  moveMotorCommand(leg6_body, 1400, 1000, 0);
  commitMoveMotorCommands();
  delay(1000);
